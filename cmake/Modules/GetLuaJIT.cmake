...
foreach(LUAJIT_HEADER ${LUAJIT_HEADER_BASENAMES})
  list(APPEND LUAJIT_HEADERS "${PROJECT_BINARY_DIR}/${LUAJIT_HEADER}")
endforeach()

foreach(LUAJIT_HEADER ${LUAJIT_HEADER_BASENAMES})
  add_custom_command(
    OUTPUT "${PROJECT_BINARY_DIR}/${LUAJIT_HEADER}"
    DEPENDS
    "${LUAJIT_INCLUDE_DIR}/${LUAJIT_HEADER}"
    COMMAND ${CMAKE_COMMAND} -E copy "${LUAJIT_INCLUDE_DIR}/${LUAJIT_HEADER}" ${PROJECT_BINARY_DIR}
  )
  install(
    FILES "${PROJECT_BINARY_DIR}/${LUAJIT_HEADER}"
