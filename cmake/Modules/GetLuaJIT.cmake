...
if(LUAJIT_VERSION_COMMIT)
  set(LUAJIT_BASENAME "LuaJIT-${LUAJIT_COMMIT}")
  set(LUAJIT_URL "https://github.com/LuaJIT/LuaJIT/archive/${LUAJIT_COMMIT}.tar.gz")
else()
  set(LUAJIT_BASENAME "LuaJIT-${LUAJIT_VERSION_MAJOR}.${LUAJIT_VERSION_MINOR}.${LUAJIT_VERSION_PATCH}${LUAJIT_VERSION_EXTRA}")
...
if(WIN32)
  ...
  set(LUAJIT_INCLUDE_DIR "${LUAJIT_INSTALL_PREFIX}/include/luajit-${LUAJIT_VERSION_MAJOR}.${LUAJIT_VERSION_MINOR}")
  set(LUAJIT_LIBRARY_NAME_WE "${LUAJIT_INSTALL_PREFIX}/lib/libluajit-5.1")
  set(LUAJIT_EXECUTABLE "${LUAJIT_INSTALL_PREFIX}/bin/luajit-${LUAJIT_VERSION_MAJOR}.${LUAJIT_VERSION_MINOR}.${LUAJIT_VERSION_PATCH}${LUAJIT_VERSION_EXTRA}")
endif()
