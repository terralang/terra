...
set(LUAJIT_COMMIT "07c228bc97f5d6f2feead8fef42a25202f977735")
if(NOT LUAJIT_VERSION_COMMIT STREQUAL "")
  set(LUAJIT_BASE "moonjit")
  set(LUAJIT_BASENAME "${LUAJIT_BASE}-${LUAJIT_COMMIT}")
  set(LUAJIT_URL "https://github.com/moonjit/moonjit/archive/${LUAJIT_COMMIT}.tar.gz")
else()
...
if(WIN32)
  ...
  set(LUAJIT_EXECUTABLE "${LUAJIT_INSTALL_PREFIX}/${LUAJIT_BASE}.exe")
else()
