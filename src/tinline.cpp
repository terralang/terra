...
bool ManualInliner::shouldInline(CallSite CS) {
...
bool ManualInliner::runOnSCC(ArrayRef<Function*> SCC) {

  SmallPtrSet<Function*, 8> SCCFunctions;
  DEBUG(dbgs() << "Inliner visiting SCC:");
  for (ArrayRef<Function*>::iterator I = SCC.begin(), E = SCC.end(); I != E; ++I) {
    Function *F = (*I);
  ...
  InlinedArrayAllocasTy InlinedArrayAllocas;
  InlineFunctionInfo InlineInfo(NULL, TD);
...
bool ManualInliner::doFinalization(ArrayRef<Function*> Funcs) {
  return removeDeadFunctions(Funcs);
}

/// removeDeadFunctions - Remove dead functions that are not included in
/// DNR (Do Not Remove) list.
bool ManualInliner::removeDeadFunctions(ArrayRef<Function*> & Funcs, bool AlwaysInlineOnly) {
  SmallVector<Function*, 16> FunctionsToRemove;

  // Scan for all of the functions, looking for ones that should now be removed
  // from the program.  Insert the dead ones in the FunctionsToRemove set.
  for (ArrayRef<Function*>::iterator I = Funcs.begin(), E = Funcs.end(); I != E; ++I) {
    Function *F = *I;
  ...
  FunctionsToRemove.erase(std::unique(FunctionsToRemove.begin(),
                          ...
                          FunctionsToRemove.end());
  for (SmallVectorImpl<Function *>::iterator I = FunctionsToRemove.begin(),
