...
enum RESERVED {
  ...
  TK_RETURN, TK_THEN, TK_TRUE, TK_UNTIL, TK_WHILE, TK_TERRA, TK_VAR, TK_STRUCT, TK_UNION, TK_QUOTE, TK_IMPORT, TK_DEFER, /* WARNING: if you add a new last terminal, make sure to update NUM_RESERVED below to be the last terminal */
