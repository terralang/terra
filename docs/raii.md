...
| Feature                                      | Description                                                                 |
|----------------------------------------------|-----------------------------------------------------------------------------|
| `A.methods.__init(self : &A)`                  | Optionally user-implemented, autogenerated with memory zero-initialized. |
...
If you have an array with an element type that is managed and implements a (possibly autogenerated) `__init` method, then the compiler will schedule an initializer call function that loops over the entries in the array and initializes the elements one-by-one.
